    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Hotel Owner'), ('buyer', 'Buyer / Investor'), ('admin', 'Admin')], default='buyer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investment_preferences', models.TextField(blank=True, help_text='e.g. budget range, preferred locations, property types')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to='profiles/owners/')),
